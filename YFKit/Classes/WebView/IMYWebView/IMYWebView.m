...
- (void)observeValueForKeyPath:(NSString*)keyPath ofObject:(id)object change:(NSDictionary*)change context:(void*)context
{
    ...
    if ([self.delegate respondsToSelector:@selector(imy_observeValueForKeyPath:ofObject:change:context:)]) {
        
        [self.delegate imy_observeValueForKeyPath:keyPath ofObject:object change:change context:context];
    }
}
- (void)initUIWebView
{
