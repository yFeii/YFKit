...
// 弹窗箭头的样式
typedef NS_ENUM(NSUInteger, YFPopoverViewArrowStyle) {
    YFPopoverViewArrowStyleRound = 0, // 圆角
    YFPopoverViewArrowStyleTriangle   // 菱角
};

@interface YFPopoverView : UIView
...
/**
 ...
 如果要修改箭头的样式, 需要在显示先设置.
 */
@property (nonatomic, assign) YFPopoverViewArrowStyle arrowStyle;
